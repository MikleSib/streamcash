          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-8 border border-gray-700/50">
            <div className="prose prose-invert max-w-none">
              ...
              <ul className="text-gray-300 mb-6 list-disc list-inside space-y-2">
                ...
                <li>Заморозка средств в безопасных сделках до подтверждения выполнения</li>
                <li>Защита от мошенничества в сделках между пользователями</li>
              </ul>
              ...
              <ul className="text-gray-300 mb-6 list-disc list-inside space-y-2">
                ...
                <li>Мониторинг подозрительных сделок между пользователями</li>
                <li>Анализ паттернов мошенничества в сделках</li>
              </ul>
