        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-8 border border-gray-700/50">
            <div className="prose prose-invert max-w-none">
              ...
              <p className="text-gray-300 mb-4">
                4.1. Комиссия за обработку платежей составляет 5% от суммы доната.
              </p>
              <p className="text-gray-300 mb-4">
                4.2. Выплаты стримерам производятся еженедельно при достижении минимальной суммы 1000 рублей.
              </p>
              <p className="text-gray-300 mb-6">
                4.3. Все платежи обрабатываются через защищенные платежные системы.
              </p>
