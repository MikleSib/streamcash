          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-8 border border-gray-700/50">
            <div className="prose prose-invert max-w-none">
              ...
              <ul className="text-gray-300 mb-6 list-disc list-inside space-y-2">
                ...
                <li>Информация о сделках и услугах (для безопасных сделок)</li>
                <li>Доказательства выполнения услуг (скриншоты, файлы)</li>
              </ul>
              ...
              <ul className="text-gray-300 mb-6 list-disc list-inside space-y-2">
                ...
                <li>Проведения безопасных сделок</li>
                <li>Разрешения споров между пользователями</li>
              ...
              <ul className="text-gray-300 mb-6 list-disc list-inside space-y-2">
                ...
                <li>Для разрешения споров в безопасных сделках (только необходимая информация)</li>
                <li>Партнёрам по обработке платежей (ЮKassa и другие)</li>
              </ul>
