...
class Settings(BaseSettings):
    ...
    TBANK_TERMINAL: Optional[str] = os.getenv("TBANK_TERMINAL", "TinkoffBankTest")
    TBANK_PASSWORD: Optional[str] = os.getenv("TBANK_PASSWORD", "TinkoffBankTest")
    TBANK_SECRET_KEY: Optional[str] = os.getenv("TBANK_SECRET_KEY", "TinkoffBankTest")
